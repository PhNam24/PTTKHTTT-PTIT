    ...
    <div class="content-area">
        <div class="content-wrapper">
            ...
            <div class="management-buttons">
                <a href="gdThemNCC.jsp" class="management-btn btn-supplier">
                ...
                <a href="#" class="management-btn btn-return" onclick="window.location.replace(`http://localhost:8080/BTL_PTTKHTTT_war_exploded/quanly/gdChinhQL.jsp`)" style="background-color: #ff4d4d">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (err) {
            ...
            notificationMessage.textContent = 'Thêm nhà cung cấp thành công!';
        ...
        function getErrorMessage(errCode) {
            switch (errCode) {
                ...
                case '2':
                    return 'Error: Lỗi khi thêm hợp đồng!';
                case '3':
                    return 'Error: Lỗi khi thêm tài khoản thanh toán!';
                case '4':
                    return 'Error: Nhà cung cấp đã tồn tại!';
                case '5':
                    return 'Error: Tài khoản thanh toán đã tồn tại!';
                default:
